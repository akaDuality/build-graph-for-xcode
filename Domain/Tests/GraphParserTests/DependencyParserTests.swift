...
""")
    ...
    func test_fullFile_xcode15_2() {
        let dependencies = parseFile(xcode15_2)
    ...
    func test_implicitDependenciesXcode15() {
        let depedencies = parseDependency("""
...
""")
    ...
    let x = "BlackBox in BlackBox (implicit dependency via file \'BlackBox.framework\' in build phase \'Link Binary\')"
